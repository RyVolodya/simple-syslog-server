...
const Header:React.FC<HeaderProps>=({onOpenMobile,theme,onToggleTheme,timeZoneInfo})=>{
  ...
  return <header className="header"><div className="header__left"><button className="header__mobile-menu" onClick={onOpenMobile} aria-label="Open navigation"><FiMenu size={21}/></button><div className="header__page-meta"><span className="header__eyebrow">{meta.eyebrow}</span><h1 className="header__title">{meta.title}</h1></div></div>
